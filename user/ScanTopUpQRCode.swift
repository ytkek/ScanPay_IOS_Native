...
class ScanTopUpQRCode: UIViewController ,UITextFieldDelegate{
    ...
    @IBAction func confirm_topup(_ sender: UIButton) {
       ...
       // self.double_confirm_merchantname.text = "Topup from Merchant\(self.merchant_name_single)"
        
       // self.double_confirm_amount.text = self.topup_amount.text
                                      ...
                                      print("Response data string:\n \(dataString)")
                                       ...
                                       DispatchQueue.main.async() {
                                        ...
                                        if result == "Don Have Balance"
                                        {
                                            ...
                                            self.topup_creditbalance.text="0.00" //self.error_message_label.isHidden = false
